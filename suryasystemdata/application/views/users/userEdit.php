            ...
            <div class="card-content">
                <form class="row" id="edit-user-form" method="post" action="">
                    ...
                    <div class="input-field col s12 m6">
                        <input id="username" disable name="username" type="text" value="<?php echo $user->username; ?>">
                    ...
                    <div class="input-field col s12 m6">
                        <select id="level" name="level">
                            ...
                            <option <?php echo ($user->level === 'biasa') ? 'selected' : ''; ?> value="biasa">Biasa</option>
                        </select>
