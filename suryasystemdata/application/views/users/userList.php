                        ...
                        <?php $no = 0; foreach($users as $row): ?>
                            <tr>
                                ...
                                <td class="center-align">
                                    <a href="<?php echo base_url('assets/datapengguna/dokumen/').$this->session->userdata('cv'); ?>" class="btn-floating halfway-fab waves-effect waves-light tooltipped" data-position="top" data-tooltip="Unduh CV"><i class="material-icons">description</i></a>
